...
/* Define to 1 if you have the declaration of `rl_completion_quote_character',
   and to 0 if you don't. */
#define HAVE_DECL_RL_COMPLETION_QUOTE_CHARACTER 1

/* Define to 1 if you have the declaration of `SANLK_INQ_WAIT', and to 0 if
   you don't. */
#define HAVE_DECL_SANLK_INQ_WAIT 1
...
#define HAVE_LIBSANLOCK_CLIENT 1
...
#define HAVE_RBD_GET_FEATURES 1
...
#define HAVE_SANLOCK_KILLPATH 1

/* whether sanlock supports sanlock_strerror */
#define HAVE_SANLOCK_STRERROR 1
...
#define HAVE_STRUCT_GAIH_ADDRTUPLE 1
...
/* Extra package name */
#define PACKAGER "Unknown,"

/* Extra package version */
#define PACKAGER_VERSION "10.el7.centos.6"
...
#define PACKAGE_STRING "libvirt 5.6.0"
...
/* QEMU bridge helper */
#define QEMU_BRIDGE_HELPER "/usr/libexec/qemu-bridge-helper"
...
#define UDEVADM "/usr/sbin/udevadm"
