...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/run.in $(srcdir)/.color_coded.in \
	$(srcdir)/.ycm_extra_conf.py.in $(srcdir)/libvirt.pc.in \
	$(srcdir)/libvirt-qemu.pc.in $(srcdir)/libvirt-lxc.pc.in \
	$(srcdir)/libvirt-admin.pc.in $(srcdir)/libvirt.spec.in \
	$(srcdir)/mingw-libvirt.spec.in AUTHORS COPYING COPYING.LESSER \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/00gnulib.m4 \
	...
	$(top_srcdir)/m4/memchr.m4 $(top_srcdir)/m4/mgetgroups.m4 \
	...
	$(top_srcdir)/m4/setlocale.m4 $(top_srcdir)/m4/sh-filename.m4 \
...
CONFIG_CLEAN_FILES = run .color_coded .ycm_extra_conf.py libvirt.pc \
	libvirt-qemu.pc libvirt-lxc.pc libvirt-admin.pc libvirt.spec \
	mingw-libvirt.spec
...
ACLOCAL = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/missing aclocal-1.13
ACL_CFLAGS = 
ACL_LIBS = -lacl
...
AUTOCONF = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/missing automake-1.13
AWK = gawk
BASH_COMPLETIONS_DIR = ${exec_prefix}/share/bash-completion/completions
...
GETOPT_H = getopt.h
GLIBC21 = yes
GLUSTERFS_CFLAGS = -D_FILE_OFFSET_BITS=64 -D__USE_FILE_OFFSET64 -D__USE_LARGEFILE64 -DUSE_POSIX_ACLS=1 -I/usr/include/uuid  
...
GNULIB_LISTEN = 1
GNULIB_LOCALECONV = 1
GNULIB_LOCALENAME = IN_LIBVIRT_GNULIB_TESTS
GNULIB_LOCALTIME = 0
GNULIB_LOG = 0
GNULIB_LOG10 = 0
GNULIB_LOG10F = 0
...
LIBNL_CFLAGS = -I/usr/include/libnl3   -I/usr/include/libnl3  
LIBNL_LIBS = -lnl-3   -lnl-route-3 -lnl-3  
...
LIBVIRT_MAJOR_VERSION = 5
LIBVIRT_MICRO_VERSION = 0
LIBVIRT_MINOR_VERSION = 6
LIBVIRT_NODELETE = -Wl,-z -Wl,nodelete
LIBVIRT_QEMU_SYMBOL_FILE = $(srcdir)/libvirt_qemu.syms
LIBVIRT_SONUM = 0
LIBVIRT_SYMBOL_FILE = libvirt.syms
LIBVIRT_VERSION = 5.6.0
LIBVIRT_VERSION_INFO = 5006:0:5006
LIBVIRT_VERSION_NUMBER = 5006000
LIBXL_CFLAGS = 
LIBXL_LIBS = 
...
MAKEINFO = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/missing makeinfo
MANIFEST_TOOL = :
MINGW_EXTRA_LDFLAGS = 
...
NO_UNDEFINED_LDFLAGS = -Wl,-z -Wl,defs
NUMACTL_CFLAGS = 
NUMACTL_LIBS = -lnuma
NUMAD = /usr/bin/numad
OBJDUMP = objdump
...
RELAXED_FRAME_LIMIT_CFLAGS =  -Wframe-larger-than=32768
...
ZFS = 
ZPOOL = 
abs_aux_dir = /home/data2/libvirt-5.6.0/build-aux
abs_builddir = /home/data2/libvirt-5.6.0
abs_srcdir = /home/data2/libvirt-5.6.0
abs_top_builddir = /home/data2/libvirt-5.6.0
abs_top_srcdir = /home/data2/libvirt-5.6.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
dvidir = ${docdir}
exec_prefix = /usr
gl_LIBOBJS =  asnprintf.o fclose.o fcntl.o fflush.o fpurge.o fseek.o fseeko.o getopt.o getopt1.o ioctl.o localtime-buffer.o mbrtowc.o mktime.o nl_langinfo.o printf-args.o printf-parse.o regex.o strerror_r.o vasnprintf.o
gl_LTLIBOBJS =  asnprintf.lo fclose.lo fcntl.lo fflush.lo fpurge.lo fseek.lo fseeko.lo getopt.lo getopt1.lo ioctl.lo localtime-buffer.lo mbrtowc.lo mktime.lo nl_langinfo.lo printf-args.lo printf-parse.lo regex.lo strerror_r.lo vasnprintf.lo
...
install_sh = ${SHELL} /home/data2/libvirt-5.6.0/build-aux/install-sh
libdir = /usr/lib64
...
srcdir = .
sysconfdir = /etc
target_alias = 2019-03-31-09:35:38,
top_build_prefix = 
top_builddir = .
top_srcdir = .
ws_plugindir = 
...
.color_coded: $(top_builddir)/config.status $(srcdir)/.color_coded.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
.ycm_extra_conf.py: $(top_builddir)/config.status $(srcdir)/.ycm_extra_conf.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
